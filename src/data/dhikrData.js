const dhikrData = {
  ...
  evening: [
    ...
    {
      id: 9,
      text: "أمسينا وأمسى الملك لله، والحمد لله ولا إله إلا الله وحده لا شريك له، له الملك وله الحمد، وهو على كل شيء قدير، رب أسألك خير ما في هذه الليلة، وخير ما بعدها، وأعوذ بك من شر هذه الليلة، وشر ما بعدها، رب أعوذ بك من الكسل وسوء الكبر، رب أعوذ بك من عذاب في النار وعذاب في القبر.",
      reference: "رواه مسلم.",
      count: 1
    },
    {
    ...
    {
      id: 21,
      text: "اللهم ما أمسى بي من نعمة أو بأحدٍ من خلقك فمنك وحدك لا شريك لك فلك الحمد ولك الشكر",
      reference: "رواه أبو داود والنسائي.",
      count: 1
    },
    {
